...
import { Loader2, Eye, EyeOff, CheckCircle, ArrowRight, Star, Mail } from "lucide-react";
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-md text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Already verified? <Link to="/login" className="text-accent font-medium hover:underline">Sign in</Link>
            </p>
          </div>
        </motion.div>
      </div>
