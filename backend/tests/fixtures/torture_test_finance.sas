/* ==========================================================================
   torture_test_finance.sas
   Mixed Data Steps, Procedures, Macros, Globals — finance domain.
   Used by translate_test.py to validate Z3 verification on real patterns.
   ========================================================================== */
...
DATA _NULL_;
    IF &cleanup_flag = 1 THEN DO;
        PUT "MIGRATION COMPLETE: %SYSFUNC(datetime(), datetime20.)";
    END;
RUN;

/* 11. FREQUENCY AND PRINT */
